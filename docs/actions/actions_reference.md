# GraphDBNext Workflows: Actions & Configuration Reference

This guide provides a detailed technical reference for all active actions in the GraphDBNext Model Builder. Each section explains the action's purpose, detailed execution logic, and an exhaustive breakdown of its Configuration UI fields.
