...
The AI settings system is designed with **dependency injection** to work both standalone and integrated with parent apps. It provides a clean separation between the plexus-builder package and any database or storage system.
