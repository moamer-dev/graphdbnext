    ...
    <div className="flex flex-col h-full bg-muted/20">
      <div className="p-4 space-y-4 border-b border-border bg-muted/10">
        <div className="flex items-center justify-between">
          <h2 className="text-[11px] font-bold uppercase tracking-[0.2em] text-muted-foreground/80 flex items-center gap-2.5">
          ...
          <div className="flex items-center gap-1.5">
            <Button 
              size="icon" 
              variant="ghost" 
              className="h-7 w-7 rounded-md text-muted-foreground hover:text-primary hover:bg-primary/5 shadow-none transition-all"
                ...
                <div key={item.id} className="relative group px-1">
                  <button
                    ...
                    className={cn(
                      ...
                      isActive 
                        ? "bg-primary/[0.04] ring-1 ring-primary/20 shadow-none" 
                        : "hover:bg-muted/60"
                    )}
                  >
                    {isActive && <div className="absolute left-1.5 top-3 bottom-3 w-1 rounded-full bg-primary" />}
                    <div className={cn(
