...
const RESOURCES = ['MODEL', 'WORKSPACE', 'CREDENTIAL', 'PROJECT', 'TEAM', 'SAVED_QUERY', 'WORKFLOW', 'DATA_SOURCE', 'DATA_SOURCE_PAGE', 'DATABASE', 'QUERY', 'ANALYTICS', 'WORKSPACE_HUB'] as const
