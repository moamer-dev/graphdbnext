...
export default function ModelBuilderSettingsPage() {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (response.ok) {
                toast.success('Plexus Builder settings saved successfully')
            } else {
    ...
    return (
        <div className="space-y-4 mt-4">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs mt-1.5 text-muted-foreground/70">
                                Configure AI features for the Plexus Builder
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <Card className="border-border/20 bg-muted/10 backdrop-blur-sm">
                <CardHeader>
                    <CardTitle className="text-sm">Plexus Features</CardTitle>
                    <CardDescription className="text-xs">
                        Enable or disable specific AI capabilities for the Plexus Builder
                    </CardDescription>
                </CardHeader>
                <CardContent>
