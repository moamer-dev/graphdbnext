# Plexus Workflows: Tools & Configuration Reference

This guide provides a detailed technical reference for all active workflow tools in the Plexus Model Builder. Unlike Actions (which modify the graph), Tools are primarily used for logic branching, execution timing, and external data retrieval.
