...
**mentions** indicates that the target node's content is mentioned in an annotation.

**name**: mentions

**Type**: Relation

**Subclass of**: [mentions](../../../Abstract%20Model/Relations/mentions.md)
...
![Example for annotates-relation](./img/example_mentions.svg)