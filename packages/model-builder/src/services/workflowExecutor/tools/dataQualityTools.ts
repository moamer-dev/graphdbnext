...
export const executeValidateTool: ToolExecutor = (tool: ToolCanvasNode, ctx: ExecutionContext) => {
...
export const executeNormalizeTool: ToolExecutor = (tool: ToolCanvasNode, ctx: ExecutionContext) => {
...
export const executeEnrichTool: ToolExecutor = (tool: ToolCanvasNode, ctx: ExecutionContext) => {
...
export const executeDeduplicateTool: ToolExecutor = (tool: ToolCanvasNode, ctx: ExecutionContext) => {
...
export const executeValidateSchemaTool: ToolExecutor = (tool: ToolCanvasNode, ctx: ExecutionContext) => {
...
export const executeCleanTool: ToolExecutor = (tool: ToolCanvasNode, ctx: ExecutionContext) => {
...
export const executeStandardizeTool: ToolExecutor = (tool: ToolCanvasNode, ctx: ExecutionContext) => {
...
export const executeVerifyTool: ToolExecutor = (tool: ToolCanvasNode, ctx: ExecutionContext) => {
