...
This module provides a flexible, dependency-injection-based settings system for AI features in the plexus-builder package.
...
```tsx
import { AISettingsProvider, ModelBuilder } from '@plexus/builder'
...
```tsx
import { AISettingsProvider } from '@plexus/builder'
...
```tsx
import { useAIFeature } from '@plexus/builder'
...
```tsx
import { useAISettings } from '@plexus/builder'
...
```tsx
import { LocalStorageAISettings } from '@plexus/builder'
...
```tsx
import { MemoryAISettings } from '@plexus/builder'
